...
import { updateProjectHeadingConfig } from "../actions";
...
export function HeadingEditor({ initialData }: { initialData: ProjectHeadingConfig }) {
  const [state, formAction, isPending] = useActionState(updateProjectHeadingConfig, {
    success: false,
    message: "",
  });
        ...
        <form action={formAction} className="lg:col-span-2">
            <Card className="bg-secondary/30 backdrop-blur-lg border-white/10">
                <CardHeader>
                    ...
                    <CardDescription>Update the text and vertical alignment of the projects section.</CardDescription>
                </CardHeader>
